...
public class CashAccount {
    ...
    public static int cashIn(String type, String details, String date, String money) {
        int row = 0;
        Connection conn = null;
        PreparedStatement psm = null;
        try {
    ...
    public static int cashDelete(Object type, Object details, Object dr_ac, Object date) {
        int line=0;
        Connection conn = null;
        PreparedStatement psm = null;
        try {
            ...
            System.out.println("cashDelete" + ex);
        } finally {
            try {
                conn.close();
                psm.close();
